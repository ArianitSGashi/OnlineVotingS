...
public class GetResultsByTotalVotesGreaterThanHandler : IRequestHandler<GetResultsByTotalVotesGreaterThanQuery, IEnumerable<Result>>
{
    ...
    public async Task<IEnumerable<Result>> Handle(GetResultsByTotalVotesGreaterThanQuery request, CancellationToken cancellationToken)
    {
        try
        {
